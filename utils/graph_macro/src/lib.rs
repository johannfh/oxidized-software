...
pub fn graph(input: TokenStream) -> TokenStream {
    let input = syn::parse_macro_input!(input as ast::GraphInput);
    ...
    match input {
        ast::GraphInput::Empty => {
            // Nothing extra to generate
        }
        ast::GraphInput::SimpleNodes(nodes) => {
